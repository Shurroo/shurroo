...
def main():
    ...
    check_dest = getattr(module.params, 'dest', None)
    check_values = getattr(module.params, 'values', None)
    if check_dest is None or check_values is None:
        module.exit_json(dest=None, changed=False, msg="Version 1.0")
        return
